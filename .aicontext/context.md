...
│           └── common
├── docs
│   └── PromiseKeeper_deferred_spawning_system.md
├── LICENSE
├── preview.png
├── readme.md
├── todo.md
...
- **PromiseKeeper public github**
  https://github.com/christophstrasen/PromiseKeeper
...
- **Namespace:** Public API exports live under `PromiseKeeper.*`; internal modules stay local unless
...
- `luacheck Contents/mods/PromiseKeeper/42/media/lua/shared/PromiseKeeper Contents/mods/PromiseKeeper/42/media/lua/shared/PromiseKeeper.lua`
